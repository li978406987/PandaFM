...
- (void)layoutSubviews {
    ...
    self.imageViewOfCoverLarge.frame = CGRectMake(5, 5, _textView.frame.size.width - 10, _textView.frame.size.height - 40);
    
    self.labelOfnickname.frame = CGRectMake(5, _imageViewOfCoverLarge.frame.size.height + 15, _imageViewOfCoverLarge.frame.size.width, _imageViewOfCoverLarge.frame.size.height / 5);
    
    self.labelOfTitle.frame = CGRectMake(5, _textView.frame.size.height, _textView.frame.size.width, _labelOfnickname.frame.size.height * 2);
