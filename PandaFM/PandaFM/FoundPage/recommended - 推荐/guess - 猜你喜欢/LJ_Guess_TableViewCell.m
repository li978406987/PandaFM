...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        FlowLayout.itemSize = CGSizeMake(self.contentView.frame.size.width / 2.7, 210);
        ...
        self.collectionViewOfGuess = [[UICollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:FlowLayout];
...
- (void)layoutSubviews {
    ...
    _collectionViewOfGuess.frame = CGRectMake(0, 0, self.contentView.frame.size.width, self.contentView.frame.size.height);
