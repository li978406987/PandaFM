...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.collectionViewOfCityColumn = [[UICollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:FlowLayout];
...
- (void)layoutSubviews {
    ...
    _collectionViewOfCityColumn.frame = CGRectMake(0, 0, self.contentView.frame.size.width, self.contentView.frame.size.height);
}
