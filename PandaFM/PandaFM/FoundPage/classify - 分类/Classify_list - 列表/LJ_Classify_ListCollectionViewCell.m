...
- (void)layoutSubviews {
    ...
    self.labelOftitle.frame = CGRectMake(_imageViewOfCoverPath.frame.size.width + _imageViewOfCoverPath.frame.origin.x + 20, 10, self.contentView.frame.size.width - 20, 40);
